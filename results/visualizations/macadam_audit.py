...
def main():
    ...
    for tier_name, filename in [
        ("Obvious (ΔE=5.0)", "chromatic-census-ultrafine-obvious-de5.0.csv"),
        ("Acceptability (ΔE=2.0)", "chromatic-census-ultrafine-acceptability-de2.0.csv"),
        ("JND (ΔE=1.0)", "chromatic-census-ultrafine-jnd-de1.0.csv"),
    ]:
